...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCenterNotFound(CenterNotFoundException ex, WebRequest request) {
        ErrorResponse res = buildResponse(ex, "CENTER_NOT_FOUND", request);
        return new ResponseEntity<>(res, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(CenterAlreadyExistsException.class)
    public ResponseEntity<ErrorResponse> handleCenterExists(CenterAlreadyExistsException ex, WebRequest request) {
        ErrorResponse res = buildResponse(ex, "CENTER_ALREADY_EXISTS", request);
        return new ResponseEntity<>(res, HttpStatus.CONFLICT);
    }
